...
email_confirmation_link = "https://wazzio.ru/api/authentication/register/confirmation?account_id="
email_confirmation_text = "Ссылка для подтверждения аккаунта: \n"

forgot_password_link = "https://wazzio.ru/api/authentication/forgot-password?token="
forgot_password_text = "Ссылка для восстановления пароля: \n"