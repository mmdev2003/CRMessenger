...
class IAuthorizationService(Protocol):
    @abstractmethod
    async def create_tokens(self, account_id: int, two_fa_status: bool) -> model.JWTToken: pass
...
class IAuthorizationRepo(Protocol):
    @abstractmethod
    async def create_account(self, account_id: int, two_fa_status: bool) -> None: pass
